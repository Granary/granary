...
#ifndef _RCU_ALLOCATOR_WRAPPERS_H_
#define _RCU_ALLOCATOR_WRAPPERS_H_
...
#   define APP_WRAPPER_FOR___kmalloc
    FUNCTION_WRAPPER(APP, __kmalloc, (void *), (size_t size, gfp_t gfp), {
        ...
        granary::printf("__kmalloc_wrapper : %llx\n", ret);
        return ret;
    })
#endif
...
#   define APP_WRAPPER_FOR_kmem_cache_alloc
    FUNCTION_WRAPPER(APP, kmem_cache_alloc, (void *), (struct kmem_cache *cache, gfp_t gfp), {
        ...
        granary::printf("kmem_cache_alloc : %llx\n", ptr);
        return ptr;
    })
#endif
...
#endif /* _RCU_ALLOCATOR_WRAPPERS_H_ */

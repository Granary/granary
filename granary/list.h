...
namespace granary {
    ...
    template <typename> struct list_meta;
    template <typename, bool> struct list_item;
    ...
    struct list_meta {
        enum {
            ...
            NEXT_POINTER_OFFSET = 0, //offsetof(list_item_with_links<T>, next_),
            PREV_POINTER_OFFSET = 0, //offsetof(list_item_with_links<T>, prev_)
        };

...
&& defined(DETACH_ADDR___schedule)

namespace granary {


    STATIC_INITIALISE_ID(trace_alloc_scheduler_entrypoint, {
        app_pc addr(reinterpret_cast<app_pc>(DETACH_ADDR___schedule));
        ...
        // Create a __schedule-specific memory allocator.

...
namespace granary {
    ...
    inline bool is_far_away(P1 p1, P2 p2) {
    ...
    template <typename P>
    inline bool addr_is_32bit(P addr_) {
    ...
    namespace detail {
        ...
        struct clean_call_argument {
            ...
            inline clean_call_argument(instrument_argument_t *func_) 
                : as_func(func_)
            ...
            /// instructions that compute the argument. The instructions must be
            /// emitted by the function.
            inline clean_call_argument(operand op) 
                : as_operand(op)
            ...
            /// values.
            template <typename T>
            inline clean_call_argument(T val_) 
